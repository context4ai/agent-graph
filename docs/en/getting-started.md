...
Validation checks JSON Schemas, relative-path containment, IDs, references, graph entrypoints, edge endpoints, subgraph calls, cross-graph recursion, dynamic resource materializers, and duplicate identities. It does not execute actions.
